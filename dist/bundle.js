...
(function (root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        options = $$$1.extend(this.element.data(), options);

        //html template for the picker UI
        if (typeof options.template !== 'string' && !(options.template instanceof $$$1))
            options.template =
        ...
        this.parentEl = (options.parentEl && $$$1(options.parentEl).length) ? $$$1(options.parentEl) : $$$1(this.parentEl);
        this.container = $$$1(options.template).appendTo(this.parentEl);
        ...
        if (typeof options.startDate === 'undefined' && typeof options.endDate === 'undefined') {
            if ($$$1(this.element).is(':text')) {
                var val = $$$1(this.element).val(),
        ...
        this.container.find('.drp-calendar')
            .on('click.daterangepicker', '.prev', $$$1.proxy(this.clickPrev, this))
            .on('click.daterangepicker', '.next', $$$1.proxy(this.clickNext, this))
            .on('mousedown.daterangepicker', 'td.available', $$$1.proxy(this.clickDate, this))
            .on('mouseenter.daterangepicker', 'td.available', $$$1.proxy(this.hoverDate, this))
            .on('change.daterangepicker', 'select.yearselect', $$$1.proxy(this.monthOrYearChanged, this))
            .on('change.daterangepicker', 'select.monthselect', $$$1.proxy(this.monthOrYearChanged, this))
            .on('change.daterangepicker', 'select.hourselect,select.minuteselect,select.secondselect,select.ampmselect', $$$1.proxy(this.timeChanged, this));

        this.container.find('.ranges')
            .on('click.daterangepicker', 'li', $$$1.proxy(this.clickRange, this));

        this.container.find('.drp-buttons')
            .on('click.daterangepicker', 'button.applyBtn', $$$1.proxy(this.clickApply, this))
            .on('click.daterangepicker', 'button.cancelBtn', $$$1.proxy(this.clickCancel, this));

        if (this.element.is('input') || this.element.is('button')) {
            this.element.on({
                'click.daterangepicker': $$$1.proxy(this.show, this),
                'focus.daterangepicker': $$$1.proxy(this.show, this),
                'keyup.daterangepicker': $$$1.proxy(this.elementChanged, this),
                'keydown.daterangepicker': $$$1.proxy(this.keydown, this) //IE 11 compatibility
            });
        } else {
            this.element.on('click.daterangepicker', $$$1.proxy(this.toggle, this));
            this.element.on('keydown.daterangepicker', $$$1.proxy(this.toggle, this));
        }
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function(side) {
            ...
            $$$1.each(this.locale.daysOfWeek, function(index, dayOfWeek) {
        ...
        move: function() {
            var parentOffset = { top: 0, left: 0 },
                containerTop;
            var parentRightEdge = $$$1(window).width();
            ...
            if (this.opens == 'left') {
                ...
                if (containerWidth + containerRight > $$$1(window).width()) {
                    this.container.css({
                        top: containerTop,
                        right: 'auto',
                        left: 9
                ...
                } else if (containerLeft + containerWidth > $$$1(window).width()) {
                    this.container.css({
                        top: containerTop,
                        left: 'auto',
                        right: 0
                ...
                if (containerLeft + containerWidth > $$$1(window).width()) {
                    this.container.css({
                        top: containerTop,
                        left: 'auto',
                        right: 0
        ...
        show: function(e) {
            ...
            this._outsideClickProxy = $$$1.proxy(function(e) { this.outsideClick(e); }, this);
            ...
            $$$1(window).on('resize.daterangepicker', $$$1.proxy(function(e) { this.move(e); }, this));
        ...
        hide: function(e) {
            ...
            $$$1(document).off('.daterangepicker');
            $$$1(window).off('.daterangepicker');
            this.container.hide();
        ...
        clickPrev: function(e) {
            var cal = $$$1(e.target).parents('.drp-calendar');
        ...
        hoverDate: function(e) {
            ...
            if (!$$$1(e.target).hasClass('available')) return;

            var title = $$$1(e.target).attr('data-title');
            ...
            if (!this.endDate) {
                this.container.find('.drp-calendar tbody td').each(function(index, el) {
                    ...
                    if ($$$1(el).hasClass('week')) return;

                    var title = $$$1(el).attr('data-title');
                    var row = title.substr(1, 1);
                    var col = title.substr(3, 1);
                    var cal = $$$1(el).parents('.drp-calendar');
                    var dt = cal.hasClass('left') ? leftCalendar.calendar[row][col] : rightCalendar.calendar[row][col];

                    if ((dt.isAfter(startDate) && dt.isBefore(date)) || dt.isSame(date, 'day')) {
                        $$$1(el).addClass('in-range');
                    } else {
                        $$$1(el).removeClass('in-range');
                    }
        ...
        monthOrYearChanged: function(e) {
            var isLeft = $$$1(e.target).closest('.drp-calendar').hasClass('left'),
        ...
        timeChanged: function(e) {
            ...
            var cal = $$$1(e.target).closest('.drp-calendar'),
    ...
    $$$1.fn.daterangepicker = function(options, callback) {
        var implementOptions = $$$1.extend(true, {}, $$$1.fn.daterangepicker.defaultOptions, options);
        this.each(function() {
            var el = $$$1(this);
